        ...
        <section className="py-16">
          <div className="container mx-auto px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Join Bizsimpl?</h2>
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  icon: <Star className="h-6 w-6 text-bizsimpl-600" />,
                  description: "Develop your skills and advance your career in a rapidly growing company."
                },
                {
                  title: "Competitive Benefits",
                  icon: <Heart className="h-6 w-6 text-bizsimpl-600" />,
                ...
                },
                {
                  ...
                  icon: <MapPin className="h-6 w-6 text-bizsimpl-600" />,
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mb-4 md:mb-0">
                        <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-bizsimpl-50 text-bizsimpl-700">
                          {position.department}
                        </span>
                    ...
                    <CustomButton variant="outline" size="sm" className="mt-4 md:mt-0">
                      Apply Now
                    </CustomButton>
                  </div>
                </motion.div>
