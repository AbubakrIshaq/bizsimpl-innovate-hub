            ...
            >
              <CustomCard variant="outlined" className="h-full">
                <div className="flex items-start">
                  <div className="p-3 bg-bizsimpl-50 rounded-lg mr-4 flex-shrink-0">
                    {benefit.icon}
                  </div>
                  <div>
